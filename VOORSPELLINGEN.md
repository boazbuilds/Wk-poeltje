...
4. Booster 8e finales: nog niet ingesteld — hoogste EV-duel is **Argentinië–Egypte 2-0** (evz 3.21 → ×2 ≈ 6.4).
...
| di 7 jul, 22:00 | Zwitserland – Colombia | **0-1** |  | 2.27 | 1-2 (2.16) | WIJZIGEN (staat nu 1-1) |

*Booster 8e finales: nog niet ingesteld — hoogste EV-duel is **Argentinië–Egypte 2-0** (evz 3.21 → ×2 ≈ 6.4).*
